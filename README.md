#### Project Overview
- This project applies econometric modeling and machine learning techniques to analyze diabetes prevalence using large-scale observational health survey data. The focus is on understanding risk factor associations, diagnosing limitations of linear models in aggregated data, and identifying high-risk population groups through classification and risk ranking.
...
- Multivariate linear regression models using diabetes prevalence as the outcome
...
- Findings are context-specific to Georgia and may not generalize directly.

#### Tools & Libraries
- Python
- pandas, NumPy
- statsmodels (econometric modeling & inference)
